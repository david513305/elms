        ...
        // if not all books deleted/received
            ...
            if(!empty($reIndexedreceivedBookArray)){//;exit();
               ...
               for($i=0;$i<count($reIndexedreceivedBookArray);$i++) { 
                ...
                $sql = "DELETE  FROM book_issues WHERE student_id = '$stid'";//print_r($sql);exit;
                $count = $conn->exec($sql);
                ...
                $sql = "INSERT INTO `book_issues` (`issue_date`, `student_id`, `user_id`, `name`, `issue_details`, `created_at`, `updated_at`)VALUES('$issuedate','$stid', '$userid', '$studentname','$serialized', now(), now())";//print_r($sql);exit;
                $count = $conn->exec($sql);
            ...
            //print_r('post isbn '.$_POST['isbnnumber']);exit();
        ...
        <div class="box col-md-12">
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-edit"></i>&nbsp;Видані книги</h2>
                </div>
                <div class="box-content">
                    <form role="form"  action="" method="post">
                        ...
                        <div class="form-group">
                            <span class="required">*</span><label for="exampleInputEmail">Студент ID</label>
                            <input type="text" name="stid" disabled value="<?php echo $unserializedIssueDetails["stid"];?>" class="auto  form-control" id="stid" placeholder="Студент ID" style="width:20%">
                            <!-- here we do same thing except disabled feature because disabled field value not posted -->
                            <input type="hidden" name="stid" value="<?php echo $unserializedIssueDetails["stid"];?>" class="auto  form-control" id="stid" placeholder="Студент ID" style="width:20%">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" disabled value="<?php echo $unserializedIssueDetails["studentname"];?>" class="form-control studentname" placeholder="Ім'я студента" name="studentname" style="width:20%">
                            <input type="hidden" value="<?php echo $unserializedIssueDetails["studentname"];?>" class="form-control studentname" placeholder="Ім'я студента" name="studentname" style="width:20%">
                      ...
                      <input type="text" name="stname" class="form-control" id="stname" placeholder="Ім'я студента" style="width:40%">
                        ...
                        <div class="alert alert-info form-inline">
                            ...
                            <?php if($totalPrevIssuedBooks== 3) {// if 3 book is issued 
                               ...
                               // print_r($crossDeadlineBook);
                               // print_r($unserializedIssueDetails["isbnnumber"]);
                                        ...
                                        <div class="row copyitem">
                                            ...
                                            <button type="button" style="float:none" class="close" data-dismiss="alert">
                                                <span class="deleteItem"
                                                      style="font-size: 19px;color:#2fa4e7">� Видалити</span></button>
                                        </div>
                                    </div>
                                <?php }
                                ...
                                <?php for ($i = 0; $i < 2; $i++) { ?>
                                    <div class="input-group col-md-12">
                                        ...
                                        <div class="row copyitem">
                                            ...
                                            <button type="button" style="float:none" class="close" data-dismiss="alert">
                                                                        <span class="deleteItem"
                                                                              style="font-size: 19px;color:#2fa4e7">� Видалити</span>
                                            </button>
                                        </div>
                                    </div>
                                <?php }
                                ...
                                <div class="input-group col-md-12">
                                    <div class="row copyitem">
                                        ...
                                        <div class="input-group col-md-4">
                                            ...
                                            <input type="text"
                                                <?php
                                                $issuedDate = strtotime($unserializedIssueDetails["book_issue_date"][0]);
                                                $submitDate = strtotime(date('Y-m-d'));
                                                $days_between = ceil(abs($submitDate - $issuedDate) / 86400);//print_r($days_between);
                                                if($days_between>7){echo 'style="color:red"';}
                                                ?>
                                                   value="<?php echo $unserializedIssueDetails["bookname"][0];?>" class="form-control bookname" placeholder="" name="bookname[]" id="">
...
<!--                            <a href="#" id="" class="addAnother" style="margin-left: 280px;"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;Додати ще один</a>-->
                        ...
                        <div class="form-inline">
                            <div class="form-group">
                                <span class="required">*</span><label for="exampleInputEmail">Термін</label>

...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-cog"></i>Список виданих книг</h2>
    </div>
        ...
        <div class="row">
            <form class="form-inline" style="margin:20px 20px" method="GET" action="search.php">
                <div class="input-group col-md-4">
                    <span class="input-group-addon">Студент ID#</span>
...
$data = '<table class="table table-striped table-bordered bootstrap-datatable" id="example">
                        <tr>
                            ...
                            <th class="text-center">Серійний номер ID</th>
                            <th class="text-center">Імя</th>
                            <th class="text-center">Дата видачі</th>
                            <th class="text-center">Всього книжок</th>

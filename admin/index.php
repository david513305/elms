    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-star-empty"></i> Панель адміністратора</h2>
            ...
            <div class="box-content">
                ...
                <div class="jumbotron" style="text-align:center">
                  <h1 style="color: maroon;text-align: center;font-size: 40px;;">Ласкаво просимо до eLibrary!</h1> 
                  <p>Система управління електронною бібліотекою</p>
                  <p>Більше, ніж <strong>10000</strong> книг, <strong>1500</strong> користувачів</p>

    ...
    if ($message_error == "") {
        ...
        for($i=0;$i<$attemptIssueBooks;$i++) {
            ...
            if($piece_of_books<1){
                ...
                header('Location:book-issue.php?stocklimited="'.$isbn.'"', true);
                ob_flush();
                exit();
            }
        }
                ...
                <div class="box-content">
                    <form role="form" action="book-issue.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="" class="auto  form-control" id="stid" placeholder="Студент ID" style="width:20%">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control studentname" placeholder="Ім'я студента" name="studentname" style="width:20%">

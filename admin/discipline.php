    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>&nbsp;Додати предмет</h2>
            </div>
            <div class="box-content">
                <form role="form" action="discipline.php" method="post">
                    <div class="form-group">
                        <span class="required">*</span><label for="exampleInputEmail1">Назва предмету</label>
                        <input type="text" name="discipline" class="form-control" id="exampleInputEmail1" placeholder="Назва предмету">
                        <span style="color:red;"><?php echo @$message_error;?></span>
                    </div>
                    <div class="form-group">
                        <span class="required">*</span><label for="exampleInputEmail">Коротка назва</label>
                        <input type="text" name="short_name" class="form-control" id="exampleInputEmail" placeholder="Коротка назва">
                        <span style="color:red;"><?php echo @$message_error;?></span>
                    </div>
                    <button type="submit" class="btn btn-default" name="submit">Надіслати</button>
                    <a href="discipline-manage.php"><button type="button" class="btn btn-default" name="submit">Скасувати</button></a>
                </form>
            </div>
        </div>
    </div>

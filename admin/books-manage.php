...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-cog"></i> Список книг</h2>
    </div>
        ...
        <div class="row">
            <form class="form-inline" style="margin:20px 20px" method="GET" action="search.php">
                <div class="input-group col-md-3">
                    <span class="input-group-addon">Імя</span>
...
$data = '<table class="table table-striped table-bordered bootstrap-datatable" id="example">
                        <tr>
                            ...
                            <th class="text-center">Назва книги</th>
                            <th class="text-center">Автор</th>
                            <th class="text-center">Категорія</th>
                            <th class="text-center">ID книги</th>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Додати новий запис</h4>
            </div>
            <div class="modal-body" style="padding: 20px 20px 50px 20px;">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Назва книги<span class="required" style="font-size:15px;">*</span></label>
                    ...
                    <br /><br />
                    <div class="form-group">
                        <label for="exampleInputEmail">Категорія<span class="required" style="font-size:15px;">*</span></label>
                    ...
                    <br /><br />
                    <div class="form-group">
                        <label for="exampleInputEmail">Автор<span class="required" style="font-size:15px;">*</span></label>
                        ...
                        <span style="color:red;"><?php echo @$message_error;?></span>
                        <span for="exampleInputEmail" style="float: left;">Виберіть один з варіантів АБО додайте новий</span>
                        <br /><br />
                        <input type="text" style="float:left;width: 96%;" name="author_name" class="form-control" id="author_name" placeholder="Імя автора"><span id="authorstatus" style="float:left"></span>
                        <!-- <span style="color:red;"><?php //echo @$message_error;?></span> -->
                    </div>
                    <br /><br /><br /><br />
                    <div class="form-group">
...
<br /><br />
                    <div class="form-group">
                        <label for="exampleInputEmail1" style="float:left">Ціна<span class="required" style="font-size:15px;">*</span></label>
                        <input style="float:left;width: 96%;" type="text" name="price" class="form-control" id="price" placeholder="Ціна">
                        <span style="color:red;"><?php echo @$message_error;?></span>
                    </div>
                    <br /><br /><br />
                    <div class="form-group">
                        <label for="exampleInputEmail1" style="float:left">Кількість книжок<span class="required" style="font-size:15px;">*</span></label>
                        <input style="float:left;width: 96%;" type="number" name="piece_of_books" class="form-control" id="piece_of_books" placeholder="Кількість книжок">
                        <span style="color:red;"><?php echo @$message_error;?></span>
                    </div>
                    <br /><br />
...
<!--                        <input type="text" name="author_name" class="form-control" id="update_author_name" placeholder="Імя автора"> -->
<!--                         <span style="color:red;">--><?php ////echo @$message_error;?><!--</span> -->
<!--                    </div>-->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="update_price" class="form-control" id="update_price" placeholder="Ціна">
                        <span style="color:red;"><?php echo @$message_error;?></span>
                    </div>
                    <div class="form-group">
                        <span class="required">*</span><label for="exampleInputEmail1">Кількість книжок</label>
                        <input type="number" name="piece_of_books" class="form-control" id="update_piece_of_books" placeholder="Кількість книжок">
                        <span style="color:red;"><?php echo @$message_error;?></span>
                    </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Скасувати</button>

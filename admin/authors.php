    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>&nbsp;Додати автора</h2>
            </div>
            <div class="box-content">
                <form role="form" action="authors.php" method="post">
                    <div class="form-group">
                        <span class="required">*</span><label for="exampleInputEmail1">Імя автора</label>
                        <input type="text" name="author" class="form-control" id="" placeholder="Імя автора">
                        <span style="color:red;"><?php echo @$message_error;?></span>
                    </div>
                    <button type="submit" class="btn btn-default" name="submit">Надіслати</button>
                    <a href="authors-manage.php"><button type="button" class="btn btn-default" name="submit">Скасувати</button></a>
                </form>
            </div>
        </div>
    </div>

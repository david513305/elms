        ...
        <div class="col-md-4">
            ...
            <div class="btn-toolbar">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="#"><i class="glyphicon glyphicon-pencil"></i> Редагувати</a></li>
                        <li><a href="#"><i class="glyphicon glyphicon-trash"></i> Видалити</a></li>
            ...
            <p>
                ...
                <a class="btn btn-success" href="#"><i class="glyphicon glyphicon-shopping-cart"></i>
                    Checkout</a>
                <a class="btn btn-danger" href="#"><i class="glyphicon glyphicon-trash"></i> Видалити</a>
            </p>

            <p>
                <a class="btn btn-default btn-lg" href="#"><i class="glyphicon glyphicon-comment"></i> Comment</a>
                <a class="btn btn-default btn-sm" href="#"><i class="glyphicon glyphicon-cog"></i> Налаштування</a>
        ...
        <div class="col-md-4">
            <div class="well">
                <ul class="nav nav-list">
                    <li class="active"><a href="#"><i class="glyphicon glyphicon-home"></i> Головна</a></li>
            ...
            <form>
                <div class="form-group">
                    ...
                    <div class="input-group input-group-lg">
                        ...
                        <input id="inputIcon" type="text" class="form-control" placeholder="Ім'я користувача">
                    </div>
                </div>
            </form>
        </div>

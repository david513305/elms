    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-cog"></i> Список користувачів</h2>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <span class="required">*</span><label for="exampleInputEmail1">Ім'я</label>
                ...
                <div class="form-group">
                    <span class="required">*</span><label for="exampleInputEmail1">Прізвище</label>
                ...
                <div class="form-group">
                    <span class="required">*</span><label for="exampleInputEmail1">Пароль</label>
                    <input type="password" name="password" class="form-control txtNewPassword password_pop" id="update_password" placeholder="password">
                    <span style="color:red;"><?php echo @$message_error;?></span>
                </div>
                <div class="form-group">
                    <span class="required">*</span><label for="exampleInputEmail">Роль</label>

...
$(document).ready(function () {
    ...
    if (url== 'http://localhost/elms/admin/discipline-manage.php' || url== 'http://localhost/elms/admin/discipline-manage.php?success=1' || url== 'http://localhost/elms/admin/discipline-manage.php#') {
      readDisciplineRecords();
    }if(url== 'http://localhost/elms/admin/session-manage.php' || url=='http://localhost/elms/admin/session-manage.php?success=1' || url=='http://localhost/elms/admin/session-manage.php?#') {
        readSessionRecords(); // calling function
    }if(url== 'http://localhost/elms/admin/authors-manage.php' || url=='http://localhost/elms/admin/authors-manage.php?success=1' || url=='http://localhost/elms/admin/authors-manage.php?#') {
        readAuthorRecords(); // calling function
    }if(url== 'http://localhost/elms/admin/books-manage.php' ||  url=='http://localhost/elms/admin/books-manage.php?success=1' || url=='http://localhost/elms/admin/books-manage.php?#') {
        readBookRecords(); // calling function
    }if(url== 'http://localhost/elms/admin/bookissue-manage.php' || url=='http://localhost/elms/admin/bookissue-manage.php?success=1' || url=='http://localhost/elms/admin/bookissue-manage.php?book-issue-available-1=1') {
        readBookIssueRecords(); // calling function
    }if(url== 'http://localhost/elms/admin/users-manage.php' || url=='http://localhost/elms/admin/users-manage.php?success=1' || url=='http://localhost/elms/admin/users-manage.php?fkeyconstraint=1' || url=='http://localhost/elms/admin/users-manage.php?#') {

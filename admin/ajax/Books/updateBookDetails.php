...
if(isset($_POST))
{
   ...
   // $update_author = $_POST['update_author'];
    ...
    $query = "UPDATE books SET book_name='$update_book_name',
    isbn_number = '$update_isbn', price = '$update_price',
     piece_of_books='$update_piece_of_books', updated_at = now() WHERE book_id = '$id'";

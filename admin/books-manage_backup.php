...
<div class="row">
        <div class="col-md-12">
            <div class="pull-right">
                <button class="btn btn-success" data-toggle="modal" data-target="#add_new_record_modal">Додати новий запис</button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="author_name" class="form-control" id="author_name" placeholder="Імя автора">
                        <!-- <span style="color:red;"><?php //echo @$message_error;?></span> -->
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="piece_of_books" class="form-control" id="piece_of_books" placeholder="Кількість книжок">
                        <span style="color:red;"><?php echo @$message_error;?></span>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        <span class="required">*</span><label for="exampleInputEmail1">Ціна</label>
                        <input type="text" name="price" class="form-control" id="update_price" placeholder="Ціна">
                        <span style="color:red;"><?php echo @$message_error;?></span>
                    </div>
                    <div class="form-group">
                        <span class="required">*</span><label for="exampleInputEmail1">Кількість книжок</label>

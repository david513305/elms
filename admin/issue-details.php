    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-star-empty"></i> Видані книги</h2>
                <div class="box-icon">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable" id="example">
                            ...
                            <tr>
                                ...
                                <th class="text-center" style="width: 280px;">Назва книги</th>
...
// late fine code
                   ...
                   <?php }?>
                        ...
                        <?php }else {?>
                            <h2 align="center" style="color: #000;"><?php echo $first_name.' '.$last_name.'  ще не видав(ла) жодної книги.'; ?></h2>
                        <?php }?>
                    </div>
                </div>
            </div>

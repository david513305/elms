...
<div class="row">
        <div class="col-md-12">
            <div class="pull-right">
                <button class="btn btn-success" data-toggle="modal" data-target="#add_new_record_modal">Додати новий предмет</button>
            </div>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-cog"></i> Перелік предметів</h2>
    </div>
        <?php
        if(isset($_GET["page"])){
        ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 20px 20px 50px 20px;">
                ...
                <div class="form-group">
                    <label for="session_name">Назва предмету</label>
                    <input type="text" style="width:96%;float:left" name="discipline" class="form-control" placeholder="Назва предмету" id="discipline"><span id="namestatus" style="float:left"></span>
                </div>
                <br /><br />
                <div class="form-group">
                    <label for="session_name">Коротка назва</label>
                    <input type="text" style="width:96%;float:left" name="short_name" class="form-control" id="short_name" placeholder="Коротка назва"><span id="shortnamestatus" style="float:left"></span>
                </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="update_discipline_name">Назва предмету</label>
                    <input type="text" name="update_discipline_name" class="form-control" placeholder="Назва предмету" id="update_discipline_name">
                </div>
                <div class="form-group">
                    <label for="update_discipline_name">Коротка назва</label>
                    <input type="text" name="update_short_name" class="form-control" id="update_short_name" placeholder="Коротка назва">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Скасувати</button>
...
$("#shortnamestatus").html('<img src="img/loader.gif" align="absmiddle">&nbsp;Checking availability...');
  ...
  // });
    ...
    {
    $("#shortnamestatus").html('<font color="red"> Коротка назва should have at least <strong>2</strong> characters.</font>');
    $("#short_name").removeClass('object_ok'); // if necessary
    $("#short_name").addClass("object_error");
    }
});

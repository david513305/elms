    ...
    if(!isset($message)) {
       ...
       $InsertQueryStudent = "INSERT INTO students (user_id, discipline_id, session_id, roll_no, created_at, updated_at) VALUES
        ...
        if(!empty($result)) {
            ...
            $message .= '<p><a href="'.SITE_URL.'activate.php?id=' . base64_encode($lastID) . '">НАТИСНІТЬ, ЩОБ АКТИВУВАТИ СВІЙ ОБЛІКОВИЙ ЗАПИС</a>';
            $message .= "</body></html>";
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading text-center">Реєстраційна форма студента</div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-info mar-0px">(Використовуйте комбінацію A-Z, a-z, 1-9, символів і мінімум 9 символів для посилення пароля)</p>
                            </div>
...
">
                        <input type="checkbox" name="terms"> Я приймаю Умови та положення</p>
                        </div>
                        <div>
